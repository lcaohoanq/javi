...
public class SparkRestExample {
    public static void main(String[] args) {
        final IUserService IUserService = new UserServiceMapImpl();
        ...
        get("/users/:id", (request, response) -> {
            ...
            return new Gson().toJson(new StandardResponse(StatusResponse.SUCCESS, new Gson().toJsonTree(
                IUserService.getUser(request.params(":id")))));
        });
        ...
        put("/users/:id", (request, response) -> {
            ...
            User editedUser = IUserService.editUser(toEdit);
        ...
        delete("/users/:id", (request, response) -> {
            ...
            IUserService.deleteUser(request.params(":id"));
        ...
        options("/users/:id", (request, response) -> {
            ...
            return new Gson().toJson(new StandardResponse(StatusResponse.SUCCESS, (IUserService.userExist(request.params(":id"))) ? "User exists" : "User does not exists"));
        });

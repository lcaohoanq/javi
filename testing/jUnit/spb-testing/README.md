- Reference from: https://github.com/mohyehia/spring-boot-testing, I will use this for practicing the ci testing with GitHub actions, many thanks to the author. 
